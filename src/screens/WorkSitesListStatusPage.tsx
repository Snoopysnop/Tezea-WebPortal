...
import { Category, Task, TaskStatus } from '../api/Model';
import TaskComponent from './TaskComponent';

const WorkSitesListStatusPage: React.FC = () => {
  
  const tasks: Task[] = [
    { id: 1, name: "Chantier 1", date: "10/10/2024", startHours: "5PM", endHour: "9PM", address: "2 Fox Street, NY", status: TaskStatus.StandBy },
    { id: 2, name: "Chantier 2", date: "10/10/2024", startHours: "2PM", endHour: "4PM", address: "2 Fox Street, NY", status: TaskStatus.InProgress },
    { id: 3, name: "Chantier 3", date: "10/10/2024", startHours: "2PM", endHour: "4PM", address: "2 Fox Street, NY", status: TaskStatus.Canceled },
    { id: 4, name: "Chantier Test 1", date: "10/10/2024", startHours: "2PM", endHour: "4PM", address: "2 Fox Street, NY", status: TaskStatus.Done },
    { id: 5, name: "Chantier Test 2", date: "10/10/2024", startHours: "2PM", endHour: "4PM", address: "2 Fox Street, NY", status: TaskStatus.Done },
    { id: 6, name: "Chantier Test 3", date: "10/10/2024", startHours: "2PM", endHour: "4PM", address: "2 Fox Street, NY", status: TaskStatus.Done },
    { id: 7, name: "Chantier Test 14", date: "10/11/2024", startHours: "2PM", endHour: "4PM", address: "2 Fox Street, NY", status: TaskStatus.Canceled },
    { id: 8, name: "Chantier Test 24", date: "10/11/2024", startHours: "2PM", endHour: "4PM", address: "2 Fox Street, NY", status: TaskStatus.Canceled },
    { id: 9, name: "Chantier Test 35", date: "10/11/2024", startHours: "2PM", endHour: "4PM", address: "2 Fox Street, NY", status: TaskStatus.Canceled },
  ];
    ...
    <Table>
      <thead>
        <tr style={{ background: 'transparent' }}>
          ...
          {selectedStatus.includes(TaskStatus.StandBy) && <th style={{ background: 'transparent' }}>A compléter</th>}
          {selectedStatus.includes(TaskStatus.InProgress) && <th style={{ background: 'transparent' }}>En cours</th>}
          {selectedStatus.includes(TaskStatus.Done) && <th style={{ background: 'transparent' }}>Terminé</th>}
          {selectedStatus.includes(TaskStatus.Canceled) && <th style={{ background: 'transparent' }}>Archivé</th>}
        </tr>
      </thead>
      <tbody>
        {Array.from(mapDateTasks.entries()).map(([date, tasks]) => (
          ...
          <tr key={date}>
            ...
            {selectedStatus.includes(TaskStatus.StandBy) && (
              <td style={{ background: 'transparent' }}>
                {tasks
                  .filter(task => task.status === TaskStatus.StandBy)
            ...
            {selectedStatus.includes(TaskStatus.Done) && (
              <td style={{ background: 'transparent' }}>
                {tasks
            ...
            {selectedStatus.includes(TaskStatus.Canceled) && (
              <td style={{ background: 'transparent' }}>
                {tasks
