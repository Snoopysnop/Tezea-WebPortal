  ...
  return (
    ...
    >
      ...
      <Modal.Body>
        ...
        {hasRequieredRoles([Role.SiteChief, Role.Commercial]) && showButtonCreate && worksiteRequest && worksiteRequest.requestStatus && worksiteRequest.requestStatus === WorkSiteRequestStatus.Standby && (
