...
class MainApi extends AbstractApi {
    ...
    public async createWorkSiteRequest(workSiteRequestData: WorkSiteRequest): Promise<WorkSiteRequest> {
        try {
            const response = await this.service.post<WorkSiteRequest>(`/api/workSiteRequests/create`, workSiteRequestData);
    ...
    public async getWorkSiteRequest(): Promise<Array<WorkSiteRequest>> {
        try {
            const response = await this.service.get('/api/workSiteRequests', {
                headers: {'Authorization': 'Bearer eyJhbGciOiJSUzI1NiIsInR5cCIgOiAiSldUIiwia2lkIiA6ICJkYU9GRkFVd01aWG92RmtwTVZWUXZvdjRfY1BHcDZ0OUd4QXNGY0FMRUV3In0..lJrkYggFbxCeSwiWhgnU48qt_kZPEAjd8yDAW_2NI_RAnI1CPlYR4JEf_UF9wq2k4P9EYV3vhMz6zFcqoMoO-TCMgZyvvROWVdOdEHpwj0gRF5MhmT7IfzuhU-7ihbNmwKmFDI2Py95qcZRQoGj9aDN6pflsU5rrU-yTK2vmZW5HglpWO6TwAGDd55BqF3LUL6FQCBTrgdzPDsvc9RazhjVJyHVlUo1dTVD5H8mypXRQdlO_Wh415nmOQxR1b24U80dWEb6Ah9I9lvbCcW9_QARVLvMVTtVGN321CQPb0K3xaM7UBlxDP-OnzYsjQFNdYoM95ikNuY1c5jdXzuDpWA'}
            })
            return response.data as Array<WorkSiteRequest>
        } catch(err) {
            throw AbstractApi.handleError(err)
        }
    }
